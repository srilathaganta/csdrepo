...
function createModels(inputHeaders, inputData) {
    ...
    for (var iin = 0; iin < inputHeaders.length; iin++) {
        headerRow = new models_1.Row(inputHeaders[iin], iin);
        headerRow.index = iin;
        if (iin == 0) {
            inputHeaders[iin].forEach(function (rawColumn, index) {
                var dataKey = index;
                if (rawColumn == null || rawColumn == '') rawColumn = ' ';
            ...
            table.headerRow = headerRow;
                ...
                var rawRow = inputHeaders[iin];               
                var row = new models_1.Row(rawRow, iin);
                var rowStyles = iin % 2 === 0 ? assign({}, theme.alternateRow, table.styles.alternateRowStyles) : {};
                table.columns.forEach(function (column) {
